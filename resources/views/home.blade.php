    ...
    <div class="flex mt-8 ml-16 mr-16">
        <div class="flex-none w-1/2">
            ...
            <div class="flex items-center justify-center mt-6 py-4">
                @auth
                    <a class="rounded-md bg-black px-4 py-2 text-white hover:bg-yellow-300 hover:text-black" href="{{ route('logout') }}">Logout</a>
                @else
                    <div class="flex flex-col items-center justify-center">
                        <a class="rounded-md bg-black px-4 py-2 text-white hover:bg-yellow-300 hover:text-black" href="{{ route('login') }}">Login to continue</a>
