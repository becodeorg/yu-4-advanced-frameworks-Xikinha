                ...
                <form class="mt-0 w-full" method="POST" action="{{ route('search') }}">
                    ...
                    <div class="grid gap-6 sm:grid-cols-2">
                        <div class="relative col-span-2">
                            ...
                            <button type="submit" class="text-white text-sm font-semibold absolute right-2.5 bottom-2.5 bg-black hover:bg-yellow-400 hover:text-black focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Search</button>
                        </div>
                    </div>
                </form>
            </div>
            ...
            <div class="w-72 m-2 bg-gradient-to-b from-black via-black rounded-lg shadow-md dark:bg-gray-800 dark:border-gray-700">
                <form method="POST" action="{{ route('storeTrack') }}">
                    ...
                    <div class="flex flex-col items-center justify-center py-4">
                        <button type="submit" class="text-sm font-semibold mx-2 rounded-md bg-black text-white px-2 py-2 hover:bg-yellow-400 hover:text-black">Add</button>
                    </div>
                </form>
            </div>
        </div>
