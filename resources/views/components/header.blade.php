...
x-data="{open:false,menu:false, lokasi:false}">
  <div class="relative z-10 bg-yellow-400">
    <div class="max-w-7xl mx-auto px-2 sm:px-4 lg:px-8">
      <div class="relative flex items-center justify-between h-16">
          ...
          <div class="hidden sm:flex sm:ml-2">
            <div class="flex">
              @auth
                ...
                <a href="{{route('dashboard')}}" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-semibold hover:bg-yellow-400 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 ">Discover</a>
                <a href="{{route('playlist')}}" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-semibold hover:bg-yellow-400 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 ">My Playlist</a>
              @endauth
            </div>
          </div>
        </div>
        ...
        <div class="flex-1 sm:flex justify-center px-2 sm:ml-6 sm:justify-end hidden">
          ...
          @else
            <a href="{{route('login')}}" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-semibold hover:bg-yellow-400 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 ">Login</a>
            <a href="{{route('register')}}" class="ml-4 px-3 py-2 rounded-md text-sm leading-5 font-medium text-gray-800 font-semibold hover:bg-yellow-400 hover:text-white transition duration-150 ease-in-out cursor-pointer focus:outline-none focus:text-white focus:bg-gray-700 ">Create account</a>
          @endauth
        </div>
